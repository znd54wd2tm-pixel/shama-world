...
ITEMS: list[dict[str, Any]] = [
    ...
    {"name": "Street Lens", "description": "Линза, которая видит больше обычного.", "rarity": "UNCOMMON", "value": 145, "image": "/assets/items/street-lens.svg"},
    ...
    {"name": "Shama Tag", "description": "Знак тех, кто знает путь в мир.", "rarity": "UNCOMMON", "value": 260, "image": "/assets/items/shama-tag.svg"},
    {"name": "Torpedo Ball", "description": "Мяч команды TORPEDO для решающего удара.", "rarity": "RARE", "value": 500, "image": "/assets/items/torpedo-ball.svg"},
    {"name": "Torpedo Scarf", "description": "Шарф с цветами трибун TORPEDO.", "rarity": "RARE", "value": 650, "image": "/assets/items/torpedo-scarf.svg"},
    {"name": "Torpedo Boots", "description": "Бутсы для тех, кто ускоряет игру.", "rarity": "RARE", "value": 800, "image": "/assets/items/torpedo-boots.svg"},
    ...
    {"name": "Torpedo Trophy", "description": "Трофей, который помнит каждый финал.", "rarity": "LEGENDARY", "value": 2400, "image": "/assets/items/torpedo-trophy.svg"},
    ...
    {"name": "Royal Visor", "description": "Визор для тех, кто видит карту целиком.", "rarity": "LEGENDARY", "value": 3200, "image": "/assets/items/royal-visor.svg"},
    ...
    {"name": "Solar Core", "description": "Сердце, собранное из солнечного импульса.", "rarity": "MYTHIC", "value": 7500, "image": "/assets/items/solar-core.svg"},
    {"name": "Shadow Mask", "description": "Маска для тихих маршрутов SHAMA.", "rarity": "RARE", "value": 900, "image": "/assets/items/shadow-mask.svg"},
    ...
    {"name": "Crown of Echoes", "description": "Корона тех, чьи истории не забывают.", "rarity": "LEGENDARY", "value": 4500, "image": "/assets/items/crown-of-echoes.svg"},
    {"name": "World Seed", "description": "Мифическое зерно будущего мира.", "rarity": "MYTHIC", "value": 10000, "image": "/assets/items/world-seed.svg"},
]

CASES = [
    {"name": "STARTER CASE", "description": "Первый шаг в коллекцию SHAMA WORLD.", "price": 100, "image": "/assets/cases/starter-case.svg", "drops": [("Neon Token", .50), ("Violet Chip", .30), ("Torpedo Ball", .15), ("Torpedo Jersey", .04), ("Torpedo Trophy", .01)]},
    {"name": "STREET CASE", "description": "Ритм улиц, редкие сигналы и ночной стиль.", "price": 300, "image": "/assets/cases/street-case.svg", "drops": [("City Sticker", .30), ("Street Lens", .35), ("Shama Prism", .25), ("Midnight Radio", .08), ("Royal Visor", .02)]},
    {"name": "TORPEDO CASE", "description": "Футбольная энергия TORPEDO внутри каждого открытия.", "price": 750, "image": "/assets/cases/torpedo-case.svg", "drops": [("Torpedo Ball", .30), ("Torpedo Scarf", .25), ("Torpedo Boots", .25), ("Torpedo Jersey", .18), ("Torpedo Trophy", .02)]},
    {"name": "SHADOW CASE", "description": "Темная серия для охотников за эпическими предметами.", "price": 1500, "image": "/assets/cases/shadow-case.svg", "drops": [("Shadow Mask", .30), ("Ghost Jacket", .35), ("Obsidian Blade", .25), ("Royal Visor", .08), ("Void Compass", .02)]},
    {"name": "LEGEND CASE", "description": "Самые редкие сигналы мира собраны в одном кейсе.", "price": 5000, "image": "/assets/cases/legend-case.svg", "drops": [("Midnight Radio", .30), ("Royal Visor", .35), ("Crown of Echoes", .20), ("Solar Core", .10), ("World Seed", .05)]},
]
