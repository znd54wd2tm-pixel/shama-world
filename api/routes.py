...
def create_app(*, dev_mode: bool = False) -> FastAPI:
    ...
    async def lifespan(_: FastAPI):
        ...
        try:
            # Run the Telegram polling loop in the same asyncio process as
            # FastAPI. This keeps the project compatible with Render's free
            # single Web Service and avoids requiring a separate worker.
            ...
            if telegram_application is not None:
                try:
                    await stop_polling(telegram_application)
